...
function STRING(length, binary) {
  var options = (typeof length === 'undefined' ? 'undefined' : _typeof(length)) === 'object' && length || { length: length, binary: binary };
...
function TEXT(length) {
  var options = (typeof length === 'undefined' ? 'undefined' : _typeof(length)) === 'object' && length || { length: length };
...
function FLOAT(length, decimals) {
  var options = (typeof length === 'undefined' ? 'undefined' : _typeof(length)) === 'object' && length || { length: length, decimals: decimals };
...
function DECIMAL(precision, scale) {
  var options = (typeof precision === 'undefined' ? 'undefined' : _typeof(precision)) === 'object' && precision || { precision: precision, scale: scale };
...
function ENUM(value) {
  var options = (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && !Array.isArray(value) && value || {
...
function GEOMETRY(type, srid) {
  var options = _.isPlainObject(type) ? type : { type: type, srid: srid };
...
try {
  var _loop = function _loop() {
    ...
    try {
        ...
        if (!DataType[helper]) {
          Object.defineProperty(DataType, helper, {
            get: function get() {
              ...
              if (_typeof(dataType[helper]) === 'object') {
                return dataType;
              }
      ...
      for (var _iterator2 = helpers[helper][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        _loop2();
      }
    } catch (err) {
  ...
  for (var _iterator = Object.keys(helpers)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    _loop();
  }
