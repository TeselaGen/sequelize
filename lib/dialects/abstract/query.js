...
var AbstractQuery = function () {
  ...
  _createClass(AbstractQuery, [{
    ...
    key: 'findTableNameInAttribute',
    value: function findTableNameInAttribute(attribute) {
    ...
    value: function getUniqueConstraintErrorMessage(field) {
      ...
      if (this.model) {
        ...
        try {
          for (var _iterator = Object.keys(this.model.uniqueKeys)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var key = _step.value;
    ...
    value: function _groupJoinData(rows, includeOptions, options) {
      ...
      var key = void 0;
      var keyI = void 0;
      var keyLength = void 0;
      var prevKey = void 0;
      var values = void 0;
      var topValues = void 0;
      var topExists = void 0;
      var checkExisting = options.checkExisting;
      // If we don't have to deduplicate we can pre-allocate the resulting array
      var itemHash = void 0;
      var parentHash = void 0;
      var topHash = void 0;
      ...
      var $keyPrefixString = void 0;
      var $prevKeyPrefixString = void 0; // eslint-disable-line
      var $prevKeyPrefix = void 0;
      var $lastKeyPrefix = void 0;
      var $current = void 0;
      var $parent = void 0;
      // Map each key to an include option
      var previousPiece = void 0;
      ...
      var getUniqueKeyAttributes = function getUniqueKeyAttributes(model) {
        ...
        uniqueKeyAttributes = uniqueKeyAttributes.result(uniqueKeyAttributes.findKey() + '.fields').map(function (field) {
      ...
      var primaryKeyAttributes = void 0;
      var uniqueKeyAttributes = void 0;
      var prefix = void 0;
