...
module.exports = function (BaseTypes) {
  ...
  RANGE.prototype._stringify = function _stringify(values, options) {
    ...
    var valuesStringified = values.map(function (value) {
      if (_this.options.subtype.stringify) {
        return _this.options.subtype.stringify(value, options);
      } else {
  ...
  BaseTypes.ARRAY.prototype._stringify = function _stringify(values, options) {
    ...
    var str = 'ARRAY[' + values.map(function (value) {
      if (_this2.type && _this2.type.stringify) {
        value = _this2.type.stringify(value, options);

        if (_this2.type.escape === false) {
          return value;
        }
      }
      return options.escape(value);
